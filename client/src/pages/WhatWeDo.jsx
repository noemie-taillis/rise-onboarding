  ...
  return (
    <Layout currentStep={6}>
      <div className="max-w-5xl mx-auto px-6 py-10 pb-20">
        ...
        >
          <p className="font-inter mb-2" style={{ color: '#7C3AED', fontWeight: 700, fontSize: '0.75rem', letterSpacing: '0.12em', textTransform: 'uppercase', margin: '0 0 10px' }}>
            L'écosystème Rise
          </p>
          <h1 className="font-fraunces mb-4" style={{ fontSize: 'clamp(2.2rem, 5vw, 3.5rem)', fontWeight: 500, color: '#F5F3FF', letterSpacing: '-0.02em', lineHeight: 1.1, margin: '0 0 16px' }}>
            On fait quoi<br />chez Rise ?
          </h1>
          <p className="font-inter" style={{ color: '#9CA3C4', fontSize: '1rem', lineHeight: 1.7, maxWidth: 520, margin: 0 }}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5 mb-10">
          {BRANDS.map((brand, i) => (
            ...
            >
              ...
              <p className="font-inter" style={{ color: brand.accent, fontWeight: 700, fontSize: '0.7rem', letterSpacing: '0.12em', textTransform: 'uppercase', margin: '0 0 12px' }}>
                {brand.category}
              </p>

              <h2 className="font-fraunces" style={{ fontSize: 'clamp(1.5rem, 3vw, 1.9rem)', fontWeight: 500, color: '#F5F3FF', letterSpacing: '-0.02em', lineHeight: 1.1, margin: '0 0 10px' }}>
                {brand.name}
              </h2>

              <p className="font-inter" style={{ color: brand.accent, fontSize: '0.85rem', fontWeight: 600, lineHeight: 1.4, fontStyle: 'italic', margin: '0 0 14px', opacity: 0.9 }}>
                "{brand.tagline}"
              </p>
        ...
        >
          <p className="font-inter mb-4" style={{ color: '#9CA3C4', fontSize: '0.72rem', fontWeight: 700, letterSpacing: '0.1em', textTransform: 'uppercase', margin: '0 0 14px' }}>
